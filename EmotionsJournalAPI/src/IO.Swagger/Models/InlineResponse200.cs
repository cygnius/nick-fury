...
namespace IO.Swagger.Models
{
    ...
    { 
        /// <summary>
        /// Gets or Sets TherapistId
        /// </summary>

        [DataMember(Name="therapistId")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TherapistId: ").Append(TherapistId).Append("\n");
        ...
        public bool Equals(InlineResponse200 other)
        {
            ...
            return 
                (
                    ...
                    TherapistId != null &&
                    TherapistId.Equals(other.TherapistId)
                ) && 
                (
                    Name == other.Name ||
                    Name != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (TherapistId != null)
                    hashCode = hashCode * 59 + TherapistId.GetHashCode();
                    if (Name != null)
